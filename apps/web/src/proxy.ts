 ...
 * 리뷰 작성도 토큰으로 리뷰를 등록하고 계정의 활동 지역 반경에서 식당을 검색하므로 마찬가지다.
 *
 ...
 */
const PROTECTED_PATHS = ['/select-restaurant', '/register-review'];
...
export const config = {
  matcher: ['/select-restaurant', '/select-restaurant/:path*', '/register-review', '/register-review/:path*'],
};
