export default function CReviewBrowserItem() {
  return (
    <div className="[&:not(:last-child)]:border-b-1 w-full border-solid border-neutral-bg20 px-20 py-16">
      ...
      <div className="mt-10 flex w-full gap-10 overflow-x-auto">
        <div className="h-116 w-155 bg-[#d9d9d9]" />
        <div className="h-116 w-155 bg-[#d9d9d9]" />
        <div className="h-116 w-155 bg-[#d9d9d9]" />
        <div className="h-116 w-155 bg-[#d9d9d9]" />
      </div>
